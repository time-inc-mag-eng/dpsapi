...
/**
 * The http metadata associated with a close session request/response
 * see Adobe DPS documentation for more information.
 */
public class CloseSessionRequest extends AbstractModifiableTicketRequest<Status> {
	private CloseSessionConfig config;

	/**
	 * Instantiates a new close session request.
	 *
	 * @param baseAddress the base address
	 * @param ticket the ticket
	 * @param config the config
	 */
	public CloseSessionRequest(String baseAddress, String ticket, CloseSessionConfig config) {
	 ...
	 */
	@Override
	public CloseSessionConfig getConfig() {
		return config;
	}
	...
	protected ProducerPath getFolioPath() {
		return ProducerPath.deleteSession();
	}
}
