...
/**
 * The http metadata associated with a publish request/response
 * see Adobe Publishing API documentation for more information.
 */
public class PublishRequest extends AbstractPublishRequest<Publish> {
	 ...
	 */
	public PublishRequest(String basePath, PublishConfig config) {
		super(basePath);
		this.config = config;
	}
	...
	protected String getRelativePath() {
		return "folios/" + config.getFolioId().replaceAll("_","*") + "/publish";
	}
}
